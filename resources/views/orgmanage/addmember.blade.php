...
@section('content')
    ...
    <script type="text/javascript">
        ...
        function schoolDelete() {
            ...
            bootbox.confirm("[" + school_name + "] 真要删掉吗?", function (result) {
                if (result) {
        ...
        function familyEdit() {
            ...
            var selectHtml = '<select class=form-control data-old="' + sex + '"><option value="0">男</option><option value="1">女</option></select>';
            ...
            selectHtml = '<select class=form-control data-old="' + party + '"><option value="0">&nbsp;</option><option value="1"></option></select>';
        ...
        function familyDelete() {
            ...
            bootbox.confirm("[" + family_relation + " : " + family_name + "] 真要删掉吗?", function (result) {
                if (result) {
        ...
        function bindRelationDeleteAction() {
            $('.relation-delete').on('click', function () {
                ...
                bootbox.confirm("[" + relationName + "] 真要删掉吗?", function (result) {
                    if (result) {
