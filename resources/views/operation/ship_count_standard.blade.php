            ...
            <div class="page-content">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <button class="btn btn-info btn-sm search_stand" style="width: 80px"><i class="icon-search"></i>검색</button>
                            ...
                            @if(!$isHolder)
                                <button class="btn btn-sm btn-info no-radius" style="width: 80px"><i class="icon-save"></i>등록</button>
                            @endif
                        </div>
                    </div>
