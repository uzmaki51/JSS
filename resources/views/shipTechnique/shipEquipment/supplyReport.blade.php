                    ...
                    <div class="row" style="font-size: 12px" id="content">
                        <table id="tbl_app" class="table table-striped table-bordered table-hover">
                            ...
                            <tr class="black br-hblue">
                                ...
                                @endforeach
                                <td class="center" colspan="3" style="width: 300px">종합</td>
                            </tr>
                            <tr class="black br-hblue">
                                <th class="center" style="width: 50px;">년도</th>
                                <th class="center" style="width: 50px;">월</th>
                                <th class="center" style="width: 50px;">구분</th>
                                <?php $shipNumber = 0; ?>
                                @foreach($ships as $ship)
                                    <th class="center shipNumber{{ $shipNumber }}" style="width: 100px">공급계획[$]</th>
                                    <th class="center shipNumber{{ $shipNumber }}" style="width: 100px">공급실적[$]</th>
                                    <th class="center shipNumber{{ $shipNumber++ }}" style="width: 100px">수행률[%]</th>
                                @endforeach
                                <th class="center" style="width: 100px">공급계획[$]</th>
                                <th class="center" style="width: 100px">공급실적[$]</th>
                                <th class="center" style="width: 100px">수행률[%]</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php
                            ...
                            @for($month = 1; $month < 13; $month++)
                                ...
                                @endforeach
                                <tr>
                                    <td class="center" colspan="2">계</td>
