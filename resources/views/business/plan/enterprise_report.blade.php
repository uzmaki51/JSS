                ...
                <div class="col-md-6">
                    <h4><b>{{transBusinessManage("title.EnterpriseReport")}}</b>
                        <small>
                            ...
                            {{transBusinessManage("title.EnterpriseReport_Write")}}
                        </small>
                    </h4>
                </div>
            </div>
    ...
    <script>
        ...
        function bindWeekTabAction() {
            ...
            $('.week-save').on('click', function () {
                ...
                $.post('reportEnterpriseUpdateWeekList', {
                    '_token': token,
                    'plan': newplan,
                    'report': newreport,
                    'reportId': reportId,
        ...
        function bindMonthTabAction() {
            ...
            $('.month-save').on('click', function () {
                ...
                $.post('reportEnterpriseUpdateMonthList', {
                    '_token': token,
                    'plan': newplan,
                    'report': newreport,
                    'reportId': reportId,
        ...
        function ShowLists( type) {
            ...
            switch (type){
                case 'week':
                    ...
                    $.post('reportEnterpriseWeek', {'_token': token, 'selDate':selDate}, function (data) {
                        $('#week').html(data);
                        bindWeekTabAction();
                    });
                    break;
                case 'month':
                    ...
                    $.get('reportEnterpriseMonth', {'year': year}, function (data) {
                        $('#month').html(data);
                    });
                    break;
            }
