                ...
                <div class="col-md-8">
                    <h4>
                        ...
                        <small>
                            ...
                            {{$info->getShipNameAndPos().' ' .$info->realname}} {{transBusinessManage("title.MemberMonthAttendPrint")}}
                        </small>
                    </h4>
                </div>
            </div>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        @for($index = 0; $index<16; $index++)
                            ...
                            <tr>
                                ...
                                <td style="width:3.8%">{{ $sday + 1}}{{transBusinessManage("captions.day")}}</td>
