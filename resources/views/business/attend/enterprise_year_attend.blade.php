                ...
                <div class="page-header">
                    <h4>
                        ...
                        <small>
                            ...
                            {{transBusinessManage("title.EnterpriseYearAttend")}}
                        </small>
                    </h4>
                </div>
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-sm-2 form-group" style="padding: 0">
                            <label style="float:left;padding:7px 5px">부서:</label>
                        ...
                        <button type="button" class="btn btn-primary btn-sm search-btn" style="float:left;width: 80px;"><i class="icon-search"></i>{{transBusinessManage("title.search")}}</button>
                        ...
                        <div style="overflow-y: scroll;width: 100%">
                            ...
                            <table class="table table-striped table-bordered table-hover arc-std-table">
                                ...
                                <tr class="black br-hblue">
                                    ...
                                    <th rowspan="2" class="center" style="width:4%">{{transBusinessManage("captions.name")}}</th>
                            ...
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                @foreach($list as $member)
                                    <tr>
                                        ...
                                        <td class="celldata center" style="width:7%">
                                            @if($member['isShip'] == 0)
                                                <a id="yearDetailMember" style="cursor: pointer;" data-userid="{{$member['id']}}" data-year="{{$year}}">{{$member['realName']}}</a>
                                            @else
                                                <a id="yearDetailShip" style="cursor: pointer;" data-userid="{{$member['id']}}" data-year="{{$year}}">{{$member['realName']}}</a>
                                            @endif
                                        </td>
        ...
        <script>
            ...
            $(function () {
                ...
                $('.search-btn').on('click', function () {
                    ...
                    var url = 'totalMemberYearReport?year='+selyear;
                ...
                $('.excel-btn').on('click', function () {
                    ...
                    var url = 'enterpriseYearAttendExcel?year='+selyear;
            ...
            $("a#yearDetailMember").on("click", function(){
                $token = '{!! csrf_token() !!}';
                $thisObj = $(this);
                ...
                $url = "memberYearReport";
                submitData($url, $param, "POST", "");
            });

            $("a#yearDetailShip").on("click", function(){
                $token = '{!! csrf_token() !!}';
                $thisObj = $(this);
                $userId = $thisObj.data("userid");
                $year = $thisObj.data("year");
