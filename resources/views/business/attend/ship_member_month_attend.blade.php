                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            @for(;$day<15;$day++)
                                ...
                                <tr @if($attend['rest'] == 1) class="rest" @endif>
                                    ...
                                    @else
                                        <td class="center">
                                            <?php $attendName = \App\Http\Controllers\Util::getStampUrl($attend['name'], $signPath, 2); ?>
                                            @if($attendName != null)
    ...
    <script>
        ...
        $(function () {
            ...
            $('.search-btn').on('click', function () {
                ...
                location.href = 'shipMemberMonthAttend?userId='+ memberId +'&year='+selyear + '&month=' + selmonth;
            });
            ...
            $('.print-year-attend').on('click', function () {
                ...
                $url = "shipMemberMonthAttendPrint";
