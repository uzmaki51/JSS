...
function transShipManager($string, $params = [], $file = 'shipManage', $locale = null)
{
    return trans($file . '.' . $string, $params, $locale);
}

function transShipOperation($string, $params = [], $file = 'operation', $locale = null)
{
    return trans($file . '.' . $string, $params, $locale);
}

function transShipMember($string, $params = [], $file = 'shipMember', $locale = null)
{
    return trans($file . '.' . $string, $params, $locale);
}

function transShipTech($string, $params = [], $file = 'tech', $locale = null)
{
    return trans($file . '.' . $string, $params, $locale);
}

function transOrgManage($string, $params = [], $file = 'orgManage', $locale = null)
{
    return trans($file . '.' . $string, $params, $locale);
}

function transDecideManage($string, $params = [], $file = 'decideManage', $locale = null)
{
    return trans($file . '.' . $string, $params, $locale);
}

function transBusinessManage($string, $params = [], $file = 'businessManage', $locale = null)
{
    return trans($file . '.' . $string, $params, $locale);
}
